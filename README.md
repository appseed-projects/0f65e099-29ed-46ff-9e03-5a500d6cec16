...
- Timestamp: `2022-05-24 13:39`
- Build ID: `0f65e099-29ed-46ff-9e03-5a500d6cec16`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/0f65e099-29ed-46ff-9e03-5a500d6cec16.git
$ cd 0f65e099-29ed-46ff-9e03-5a500d6cec16
```
